...
<div class="col-md-12 mx-auto">
  <form method="post" enctype="multipart/form-data">
    ...
    <div class="">
      <textarea  rows="8" name="content" id="floatingInput" placeholder="Post content" type="content" class="form-control"><?=old_value('content')?></textarea>
    </div>
	...
	<div class="col-md-12 mx-auto">
	  <form method="post" enctype="multipart/form-data">
	    ...
	    <?php if(!empty($row)):?>
		    ...
		    <div class="">
            <textarea  rows="8" name="content" id="floatingInput" placeholder="Post content" type="content" class="form-control"><?=old_value('content',$row['content'])?></textarea>

	    </div>
	      <?php if(!empty($errors['content'])):?>
	      <div class="text-danger"><?=$errors['content']?>
        </div>
	      <?php endif;?>
